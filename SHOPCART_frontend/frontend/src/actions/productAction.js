...
export const getAdminProduct = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`${url}/api/v1/admin/products`,{headers:{token:getCookies('token')}});
...
export const createProduct = (productData) => async (dispatch) => {
  try {
    ...
    const config = {
      headers: { "Content-Type": "application/json",token:getCookies('token') },
    };
...
export const deleteProduct = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.delete(`${url}/api/v1/admin/product/${id}`,{headers:{token:getCookies('token')}});
...
export const getAllReviews = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`${url}/api/v1/reviews?id=${id}`,{headers:{token:getCookies('token')}});
...
export const deleteReviews = (reviewId, productId) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.delete(
      `${url}/api/v1/reviews?id=${reviewId}&productId=${productId}`,{headers:{token:getCookies('token')}}
    );
